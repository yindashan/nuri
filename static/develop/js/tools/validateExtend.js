...
// host_id 例: GD0860186806
jQuery.validator.addMethod("host_id", function(value, element) {       
return this.optional(element) || /^GD[0-9]{10}$/.test(value);  
}, "Please enter a valid host_id");  


// 增加只能是字母、数字、下划线的验证         
jQuery.validator.addMethod("chrnum", function(value, element) {         
   return this.optional(element) || (/^([a-zA-Z0-9_#]+)$/.test(value));         
}, "只能输入数字、字母、下划线、#号或者它们的组合");
